...
<figure markdown="span">
  ![](images/cylinder-block-5s-fe-components.webp#illustration)
</figure>
...
9.  Remove air cleaner assembly.
    ...
    3.  Disconnect the air cleaner hose from the throttle body, and remove the air cleaner cap and element.
...
11. Remove cruise control actuator (w/ cruise control system) and linkage.
...
15. Remove A/C VSV.
    ...
    1.  Disconnect the A/C VSV connector.
    2.  Disconnect the following hoses:

        1. Air hose from ISC valve
...
20. [](){ #p-em-185 } Disconnect engine wire from luggage compartment.
    ...
    1.  Disconnect the following connectors:
        ...
        <figure markdown="span">
          ![](images/EM9103.webp#illustration)
        </figure>
...
25. Disconnect radiator hose from water outlet housing.
...
31. Remove idler pulley bracket and A/C compressor without disconnecting hoses.
...
39. [](){ #p-em-190 } Remove lateral control rod (M/T) and air cleaner case bracket.
    ...
    (M/T) Remove the five bolts, the control rod and case bracket. Disconnect the charcoal canister tube and ground
...
40. Remove engine and transaxle assembly from vehicle.
    ...
    7.  Lift the engine out of the vehicle slowly and carefully.
    ...
    10. Measure the Plastigage at its widest point.
        ...
        **Maximum clearance:** 0.08 mm (0.0031 in.)
        ...
        !!! tip "Hint"
            ...
            cannot be determined, select the correct bearing by adding together the numbers imprinted on the cylinder
            block and crankshaft, then select the bearing with the same number as the total. There are five sizes of
...
4.  Inspect cylinder bore diameter.
    ...
    !!! tip "Hint"
        ...
        There are three sizes of the standard cylinder bore diameter, marked "1", "2" and "3" accordingly. The mark
    ...
    * STD
        * Mark "1" – 87.000 – 87.010 mm (3.4252 – 3.4256 in.)
        * Mark "2" – 87.010 – 87.020 mm (3.4256 – 3.4260 in.)
        * Mark "3" – 87.020 – 87.030 mm (3.4260 – 3.4264 in.)

    **Maximum diameter:**

    * STD – 87.23 mm (3.4342 in.)
    * O/S 0.50 – 87.73 mm (3.4350 in.)
...
2.  Inspect piston.
    ...
    1.  **Inspect piston oil clearance**
        ...
        !!! tip "Hint"
            ...
            There are three sizes of the standard piston diameter, marked "1", "2" and "3" accordingly. The mark is
            stamped on the piston top.

        1.  Using a micrometer, measure the piston diameter at right angles to the piston pin center line, 23.5 mm
            (0.925 in.) from the piston head.

            **Piston diameter:**

            * STD
                * Mark "1" – 86.911 – 86.921 mm (3.4217 – 3.4221 in.)
                * Mark "2" – 86.921 – 86.931 mm (3.4221 – 3.4225 in.)
                * Mark "3" – 86.931 – 86.941 mm (3.4225 – 3.4229 in.)
        ...
        3.  Subtract the piston diameter measurement from the cylinder bore diameter measurement.
            ...
            **Maximum oil clearance:** 0.119 mm (0.0047 in.)
            ...
            If the oil clearance is greater than maximum, replace all the four pistons and rebore all the four
            cylinders. If necessary, replace the cylinder block.

            !!! tip "Hint (Use new cylinder block)"
    ...
    2.  **Inspect piston ring groove clearance**
        ...
        **Ring groove clearance:** 0.030 – 0.070 mm (0.0012 – 0.0028 in.)
    ...
    3.  **Inspect piston ring end gap**
        ...
        2.  Using a piston, push the piston ring a little beyond the bottom of the ring travel, 115 mm (4.53 in.) from
        ...
        3.  [](){ #p-em-204 } Using a feeler gauge, measure the end gap.
            ...
            * No.2 – 0.350 – 0.600 mm (0.0138 – 0.0234 in.)
            ...
            * Oil (Side rail) – 1.15 mm (0.0453 in.)
            ...
            If the end gap is greater than maximum, replace the piston ring. If the end gap is greater than maximum,
...
3.  Inspect connecting rod.
    ...
    2.  [](){ #p-em-205 } **Inspect piston pin oil clearance**
        ...
        3.  Subtract the piston pin diameter measurement from the bushing inside diameter measurement.
            ...
            **Maximum oil clearance:** 0.05 mm (0.0020 in.)
            ...
            If the oil clearance is greater than maximum, replace the bushing. If necessary, replace the piston and
            piston pin as a set.
    ...
    3.  **If necessary, replace connecting rod bushing**
        ...
        4.  [](){ #p-em-206 } Using a pin hole grinder, hone the bushing to obtain the standard specified clearance
    ...
    4.  **Inspect connecting rod bolts**
        ...
        1.  Install the cap nut to the connecting rod bolt. Check that the cap nut can be turned easily by hand to the
            end of the thread.
        ...
        2.  If the cap nut cannot be turned easily, measure the outside diameter of the connecting rod bolt.
            ...
            **Standard diameter:** 7.860 – 8.000 mm (0.3094 – 0.3150 in.)

            **Minimum diameter:** 7.60 mm (0.2992 in.)

            !!! tip "Hint"

                If the location of this area cannot be judged by visual inspection, measure the outer diameter at the
...
2.  Calculate amount to bore cylinders.
    ...
    2.  Calculate the amount each cylinder is to be rebored as follows:
        ...
        * P = Piston diameter
        * C = Piston clearance – 0.079 – 0.099 mm (0.0031 – 0.0039 in.)
...
1.  Install main bearings.
    ...
    !!! tip "Hint"
        ...
        * Main bearings come in widths of 19.2 mm (0.756 in.) and 22.9 mm (0.902 in.). Install the 22.9 mm (0.902
          in.) bearings in the No.3 cylinder block journal position with the main bearing cap. Install the 19.2 mm
...
2.  Install upper thrust washers.
    ...
    Install the two thrust washers under the No.3 journal position of the cylinder block with the oil grooves facing
    outward.
...
4.  Install main bearing caps and lower thrust washers.
    ...
    4.  Install and uniformly tighten the ten bolts of the main bearing caps in several passes in the sequence shown.
...
6.  Install connecting rod caps.
    ...
    1.  **Place connecting rod cap on connecting rod**
    ...
    2.  **Install connecting rod cap nuts**
        ...
        1.  Apply a light coat of engine oil on the threads and under the cap nuts.
        2.  Using SST, install and alternately tighten the cap nuts in several passes.

            **SST** `09011-38121`

            **Torque:** 250 kg-cm (18 ft-lb, 25 N·m)

            If any one of the cap nuts does not meet the torque specification, replace the connecting rod bolt and cap
            nut as a set.
...
8.  Install alternator bracket.
    ...
    Install the alternator bracket with the five bolts.
...
14. (M/T) Install clutch disc and cover. (See page CL-10)
...
3.  Install engine and transaxle assembly in vehicle.
    ...
    6.  (M/T) Install the LH mounting bracket to the transaxle case with the three bolts.
    ...
    13. Remove the engine chain hoist from the engine.

4.  [](){ #p-em-218 } Install RH engine mounting stay.
...
5.  Install lateral control rod (M/T) and air cleaner case bracket.
    ...
    (M/T) Install the control rod, case bracket and charcoal canister tube with the five bolts, and connect the ground
    ...
    **Torque:** 360 kg-cm (26 ft-lb, 35 N·m)
    ...
    transaxle). Do not the tighten the bolt (A).
...
10. [](){ #p-em-220 } Install rear engine mounting insulator.
    ...
    3.  Tighten the three bolts holding the mounting bracket to the body.
...
13. Install A/C compressor and idler pulley bracket.
    ...
    4.  Tighten the two bolts of the lower side holding the A/C compressor to the cylinder block.
...
15. Install front exhaust pipe.
    ...
    6.  Install the two bolts holding the stopper bracket of the front exhaust pipe to the tailpipe stopper bracket.

        **Torque:** 190 kg-cm (190 ft-lb, 19 N·m)

    7.  Tighten the two bolts holding the front exhaust pipe to the tailpipe.
...
20. Connect radiator hose to water outlet.
...
24. Connect engine wire to luggage compartment.
...
25. [](){ #p-em-224 } Install ignition coil and igniter.

    1.  Install the ignition coil and igniter with the two bolts. Connect the noise filter.
...
33. Install cruise control actuator (w/ cruise control system) and accelerator linkage.
...
35. Install air cleaner assembly.
    ...
    3.  Connect the air cleaner hose to the throttle body.
    4.  Install the air cleaner cap.
...
39. Fill with engine oil. (See page LU-8)
    ...
    * Drain and refill
        * w/ Oil filter change – 4.2 liters (4.4 US qts, 3.7 Imp. qts)
...
42. [](){ #p-em-227 } Install engine under covers.
43. Install engine hood.
44. Install engine compartment side panels.
45. Perform road test.

    Check for abnormal noise, shock, slippage, correct shift points and smooth operation.

46. Recheck engine coolant and oil levels.
