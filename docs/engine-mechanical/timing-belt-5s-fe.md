...
<figure markdown="span">
  ![](images/EM8918.webp#illustration)
</figure>
...
16. Remove timing belt from camshaft timing pulley.
    ...
    !!! tip "Hint (when re-using timing belt)"
        ...
        Place the matchmarks on the timing belt and camshaft timing pulley, and place matchmark on the timing belt to
...
17. Remove camshaft timing pulley.
    ...
    Using SST, remove the bolt, plate washer and timing pulley.
...
18. Remove crankshaft pulley.
    ...
    1.  Using SST, remove the pulley bolt.
        ...
        **SST** `09213-54015` (`09214-00030`) and `09330-00021`
        ...
        !!! tip "Hint (when re-using timing belt)"
            ...
            After loosening the crankshaft pulley bolt, check that the timing belt matchmark aligns with the end of
            the No.1 timing belt cover when the crankshaft pulley groove is aligned with the timing mark "0" of the
            No.1 timing belt cover. If the matchmark does not align, align as follows:
    ...
    2.  Using SST, remove the pulley.
        ...
        **SST** `09213-60017` (`09213-00020`, `09213-00030`, `09213-00050`)
...
21. Remove timing belt.
    ...
    !!! tip "Hint (when re-using timing belt)"
        ...
        Draw a direction arrow on the timing belt (in direction of engine revolution), and place the matchmarks on the
...
1.  Inspect timing belt.
    ...
    5.  If there is noticeable wear on the belt teeth, check the timing cover for damage, and correct gasket
        installation and the foreign material on the pulley teeth.
...
3.  Inspect tension spring.
    ...
    1.  Measure the free length of the tension spring.
    ...
    2.  Measure the tension of the tension spring at the specified installed length.
        ...
        **Installed tension:** 4.75 – 5.25 kg (10.5 – 11.6 lb, 47 – 52 N·m) at 50.5 mm (1.988 in.)
    ...
    1.  Install the pulley with the bolt.
        ...
        **Torque:** 425 kg-cm (31 ft-lb, 42 N·m)
        ...
        !!! tip "Hint"
            ...
            Use bolt 35 mm (1.38 in.) in length.
...
4.  Temporarily install No.1 idler pulley and tension spring.
    ...
    1.  Install the pulley with the bolt. Do not tighten the bolt yet.

        !!! tip "Hint"

            Use bolt 42 mm (1.65 in.) in length.

    2.  Install the tension spring.
    3.  Pry the pulley toward the left as far as it will go and tighten the bolt.
...
8.  Install crankshaft pulley.
    ...
    1.  Align the pulley set key with the key groove of the pulley, slide on the pulley.
...
9.  Install camshaft timing pulley.
    ...
    2.  Using SST, install the plate washer and bolt.
...
11. Install timing belt.
    ...
    !!! tip "Hint (when re-using timing belt)"
        ...
        * Check that the matchmark on the timing belt matches the end of the No.1 timing belt cover.
            ...
            they align. (See [Removal of timing belt](#p-em-51))
    ...
    2.  Install the timing belt, insure that there is tension between the crankshaft timing pulley and camshaft timing
        pulley.
...
14. Install No.2 timing belt cover.
    ...
    1.  Install the two gaskets to the No.1 and No.2 belt covers.
