...
<figure markdown="span">
  ![](images/EM9112.webp#illustration)
</figure>

[](){ #p-em-62 }

<figure markdown="span">
  ![](images/EM9113.webp#illustration)
</figure>
...
22. Remove EGR vacuum modulator and VSV.
    ...
    1.  Disconnect the EGR VSV connector.
    2.  Disconnect the following hoses:

        1. Vacuum hose from EGR valve
...
25. [](){ #p-em-67 } Remove water outlet and housing.
    ...
    3.  Remove the bolt, and disconnect the fuel return hose.
    4.  Disconnect the following hoses:
        ...
        4. Heater water hose
        5. Water by-pass hose from water by-pass pipe
...
28. Remove water by-pass pipe.
    ...
    1.  Disconnect the following hoses:
        ...
        3. Vacuum hose from turbocharging pressure VSV
        4. Heater water hose
...
29. Remove intake manifold stays.
    ...
    1.  Disconnect the alternator wire clamp from the wire bracket.
...
30. Remove No.1 air tube.
    ...
    1.  Disconnect the vacuum hose from the turbocharging pressure VSV.
...
31. [](){ #p-em-69 } Remove T-VIS vacuum tank, T-VIS VSV, turbocharging pressure VSV and bracket.
    ...
    2.  Disconnect the following hoses:
        ...
        1. Vacuum hose (from T-VIS VSV) from T-VIS actuator
...
32. Disconnect engine wire from intake manifold.
    ...
    1.  Disconnect the two engine wire clamps from the mount bolts on the No.2 timing belt covers.
...
38. Remove No.3 timing belt cover.
    ...
    !!! tip "Hint"
        ...
        * Support the timing belt, so that the meshing of the crankshaft timing pulley and timing belt does not
          shift.
...
39. [](){ #p-em-71 } Remove camshafts.
    ...
    Uniformly loosen and remove the ten bearing cap bolts in several passes in the sequence shown, and remove the
...
1.  Clean top surfaces of pistons and cylinder block.
    ...
    1.  Turn the crankshaft, and bring each piston to top dead center (TDC). Using a gasket scraper, remove all
...
3.  Inspect cylinder head.
    ...
    1.  **Inspect for flatness**
        ...
        Using precision straight edge and feeler gauge, measure the surfaces contacting the cylinder block, T-VIS
    ...
    2.  **Inspect for cracks**
        ...
        Using a dye penetrant, check the combustion chamber, intake ports, exhaust ports and cylinder block
        surface for cracks.
...
5.  [](){ #p-em-75 } Inspect valve stems and guide bushings.
    ...
    2.  Using a micrometer, measure the diameter of the valve stem.
        ...
        * Intake – 5.960 – 5.975 mm (0.2346 – 0.2352 in.)
    ...
    3.  Subtract the valve stem diameter measurement from the guide bushing inside diameter measurement.
        ...
        * Intake – 0.025 – 0.058 mm (0.0010 – 0.0023 in.)
...
6.  If necessary, replace valve guide bushings.
    ...
    1.  (w/ Snap Ring)
        ...
        Insert an old valve wrapped with tape into the valve guide bushing, and break off the valve guide bushing
        by hitting it with a hammer. Remove the snap ring.

        !!! tip "Hint"

            Wrap the tape approx. 13 mm (0.51 in.) from the valve stem end.
    ...
    5.  Select a new guide bushing (STD size or O/S 0.05).
        ...
        |---|---|
        | 10.988 – 11.006 (0.4326 – 0.4333) | Use STD |
        | 11.038 – 11.056 (0.4346 – 0.4353) | Use O/S 0.05 |

        If the bushing bore diameter of the cylinder head is greater than 11.006 mm (0.4333 in.), machine the
        bushing bore to the following dimension:

        11.038 – 11.056 mm (0.4346 – 0.4353 in.)

        If the bushing bore diameter of the cylinder head is greater than 11.056 mm (0.4353 in.), replace the
        cylinder head.

    6.  Gradually heat the cylinder head to 80 – 100°C (176 – 212°F).
    7.  Using SST and a hammer, tap in a new guide bushing until the snap ring makes contact with the cylinder
        head.
...
7.  Inspect and grind valves.
    ...
    4.  Check the valve overall length.
        ...
        * Intake – 105.50 mm (4.1535 in.)
        * Exhaust – 99.55 mm (3.9193 in.)

        **Minimum overall length:**

        * Intake – 104.80 mm (4.1260 in.)
        * Exhaust – 98.85 mm (3.8917 in.)
...
8.  [](){ #p-em-78 } Inspect and clean valve seats.
    ...
    2.  Check the valve seating position.
        ...
        Apply a thin coat of prussion blue (or white lead) to the valve face. Lightly press the valve against the
...
9.  Inspect valve springs.
    ...
    2.  Using vernier calipers, measure the free length of the valve spring.
        ...
        **Free length:** 44.43 mm (1.7492 in.)
    ...
    3.  Using a spring tester, measure the tension of the valve spring at the specified installed length.
        ...
        **Installed tension:** 20.5 – 24.1 kg (45.2 – 53.1 lb, 201 – 236 N) at 34.4 mm (1.354 in.)
...
10. Inspect camshafts and bearings.
    ...
    2.  [](){ #p-em-80 } **Inspect cam lobes**
        ...
        **Standard cam lobe height:** 41.010 – 41.110 mm (1.6146 – 1.6185 in.)
...
[](){ #p-em-83 }
## Inspection of Toyota – variable induction system (T-VIS) components

1.  Inspect T-VIS valve.

    1.  **Inspect for flatness**

        Using precision straight edge and feeler gauge, measure the surfaces contacting the cylinder head and
        intake manifold for warpage.
    ...
    2.  **Inspect for operation**
        ...
        1. With 400 mmHg (15.75 in.Hg, 53.3 kPa) of vacuum applied to the actuator, check that the control valve
           moves smoothly to the fully closed position.
        2. With the vacuum released, check that the control valve fully opens quickly.
...
2.  [](){ #p-em-87 } Install camshafts.
    ...
    5.  Install and uniformly tighten the ten bearing cap bolts on one side in several passes in the sequence
        shown.
...
4.  Install No.3 timing belt cover.

    Install the No.3 belt cover with the five bolts.
...
7.  Install cylinder head cover.
    ...
    3.  Install the head cover with the twelve seal washers and screws. Uniformly tighten the screw in several
        passes.
...
9.  [](){ #p-em-89 } Install T-VIS valve and intake manifold.
...
10. Install engine wire to intake manifold.
    ...
    1.  Install the engine wire clamp to the intake manifold with the two bolts.
    ...
    5.  Connect the ground strap with the bolt.
...
11. [](){ #p-em-90 } Install T-VIS vacuum tank, T-VIS VSV, turbocharging pressure VSV and bracket.
    ...
    1.  Install the T-VIS vacuum tank, T-VIS VSV, turbocharging pressure VSV and bracket assembly with the two
        bolts.
...
13. Install intake manifold stays.
    ...
    1.  Install the manifold stay with the two bolts. Install the two manifold stays.
...
14. [](){ #p-em-91 } Install water by-pass pipe.

    1.  Install a new O-ring to the pipe.
    2.  Apply soapy water on the O-ring.
    3.  Install a new gasket to the water pump.
    4.  Install the water by-pass pipe with the two nuts and two bolts.
...
17. Install water outlet and housing.
    ...
    1.  Install a new gasket and the water outlet and housing assembly with the two bolts.

        **Torque:** 400 kg-cm (29 ft-lb, 39 N·m)

    2.  Connect the following hoses:

        1.  Water by-pass hose from water by-pass pipe
        ...
        4.  Radiator hose
        5.  Water by-pass pipe hose from ISC valve
        6.  Heater water hose
    ...
    4.  Install the fuel return hose with the bolt.
    5.  Connect the following connectors:
...
18. Install EGR valve and pipe.
    ...
    1.  Install two new gaskets, the EGR valve and pipe assembly with the four bolts.

        **Torque:**

        * Intake manifold side – 195 kg-cm (14 ft-lb, 19 N·m)
        * Cylinder head side – 260 kg-cm (19 ft-lb, 25 N·m)
...
19. Install vacuum pipe.
    ...
    1.  Install the vacuum pipe with the bolt.
...
21. Install LH engine hanger.
    ...
    Install the LH engine hanger with the two bolts.

    **Torque:**

    * 12 mm head bolt – 130 kg-cm (9 ft-lb, 13 N·m)
...
41. Install engine hood side panels.
42. Install engine under covers.
43. Perform road test.

    Check for abnormal noise, shock, slippage, correct shift points and smooth operation.

44. Recheck engine coolant and oil levels.
