...
<figure markdown="span">
  ![](images/CH0848.webp#illustration)
</figure>
...
2.  **Remove drive belt**
    ...
    2.  Loosen the adjusting bolt, and disconnect the drive belt from the alternator.
...
3.  **Remove alternator**
    ...
    2.  Remove the nut, and disconnect the alternator wire.
    3.  Remove the pivot bolt, adjusting lock bolt and alternator.

[](){ #p-ch-7 }
## Components

<figure markdown="span">
  ![](images/CH0922_CH0921.webp#illustration)
</figure>
...
4.  **Remove pulley**
    ...
    6.  Turn SST (B) and remove SST (A and B).
    7.  Remove the pulley nut and pulley.
...
1.  **Inspect rotor for open circuit**
    ...
    **Standard resistance (Cold):** 2.8 – 3.0 Ω
...
3.  [](){ #p-ch-11 } **Inspect slip rings**
    ...
    2.  Using vernier calipers, measure the slip ring diameter.
...
1.  **Inspect exposed brush length**
    ...
    **Minimum exposed length:** 1.5 mm (0.059 in.)
    ...
    If the exposed length is less than minimum, replace the brushes (70 A type) or brushes and brush holder assembly
    (80 A and 100 A types).

2.  [](){ #p-ch-12 } **(70 A type) If necessary, replace brushes**
    ...
    6.  Apply insulation paint to the soldered point.
...
2.  [](){ #p-ch-13 } **If necessary, replace front bearing**
...
1.  **Install rotor to rectifier end frame**
    ...
    2.  Install the rotor to the rectifier end frame.
...
3.  [](){ #p-ch-15 } **Install pulley**
    ...
    3.  Check that SST (A) is secured to the pulley shaft.
    ...
    6.  Remove the alternator from SST (C).
...
5.  [](){ #p-ch-16 } **Install IC regulator and brush holder**
    ...
    **(70 A Type)**
    ...
    1.  Install the brush holder cover to the brush holder.
        ...
        !!! note "Notice"
            ...
            Be careful about the holder installation direction.

    2.  Place the IC regulator together with the brush holder horizontally on the rectifier end frame.
    3.  Install the five screws until there is a clearance of approx. 1 mm (0.04 in.) between the brush holder and
        connector.
    ...
    **(80 A and 100 A Types)**
    ...
    2.  Install the five screws until there is a clearance of approx. 1 mm (0.04 in.) between the brush holder and
        connector.
...
1.  **Install alternator**
    ...
    1.  Mount the alternator on the alternator brackets with the pivot bolt and adjusting lock bolt. Do not tighten
        the bolts yet.
    2.  Connect the alternator connector.
    3.  Connect the alternator wire with the nut.
...
4.  **Perform on-vehicle inspection** (See [On-vehicle inspection, steps 5–7](on-vehicle-inspection.md#p-ch-4))
